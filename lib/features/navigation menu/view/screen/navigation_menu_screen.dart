...
class NavigationMenuScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(NavigationMenuController(preferredIndex: initialTabIndex));
    controller.updateTabIndex(initialTabIndex??0); // Update the tab index on start
    return Scaffold(
      // -- Page View
      body: PageView(
