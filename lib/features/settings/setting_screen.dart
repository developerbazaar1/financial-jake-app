...
final List<SettingsOption> settingsOptions = [
  SettingsOption(
    ...
    onTap: (context) => context.pushReplacementNamed(RouteConstants.editProfileScreen),
  ),
  SettingsOption(
    title: 'Change Password',
    leadingIcon: AppImage.changepasswordIcon,
    trailingIcon: AppImage.rightarrow,
    onTap: (context) => context.pushReplacementNamed(RouteConstants.resetPassword,extra: true),
  ),
  SettingsOption(
    title: 'Notifications',
  ...
  SettingsOption(
    ...
    leadingIcon: AppImage.changepasswordIcon,
    trailingIcon: AppImage.rightarrow,
    onTap: (context) => context.pushReplacementNamed(RouteConstants.historyScreen),
  ),
  SettingsOption(
    title: 'Privacy Policy',
    leadingIcon: AppImage.privacyIcon,
    trailingIcon: AppImage.rightarrow,
    onTap: (context) => context.pushReplacementNamed(RouteConstants.privacyPolicy),
  ),
  SettingsOption(
    title: 'Customer Support',
    leadingIcon: AppImage.privacyIcon,
    trailingIcon: AppImage.rightarrow,
    onTap: (context) => context.pushReplacementNamed(RouteConstants.customerSupport),
  ),
  SettingsOption(
    title: 'Terms & Conditions',
    leadingIcon: AppImage.privacyIcon,
    trailingIcon: AppImage.rightarrow,
    onTap: (context) => context.pushReplacementNamed(RouteConstants.termsCondtition),
  ),
  SettingsOption(
    title: 'Log Out',
