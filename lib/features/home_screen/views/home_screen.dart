              ...
              children: [
                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    GestureDetector(
                      onTap: () {
                        controller.hidePopup(); // Close popup when clicking outside
                      },
                      child: Stack(
                        children: [
                          // Main Container
                            ...
                            ...List.generate(
                              ...
                              (index) => Column(
                                children: [
                                  InkWell(
                                    onTap: () {
                                      if(controller.assessmentScore[index]['data1']==0){
                                      ...
                                      child: Column(
                                        children: [
                                          Row(
                                            children: [
                                              Container(
                                                padding:  EdgeInsets.symmetric(horizontal: width*0.025, vertical: height* 0.005), // Add padding for spacing
                                                alignment: Alignment.center,
                                                decoration: BoxDecoration(
                                                  color: AppList.getProgressColor(
                                                    controller.assessmentScore[index]['data1']!,
                                                  ).withOpacity(0.2),
                        ...
                        SizedBox(height: height * 0.01),
                        CustomDropDown(label:   "New Assessments", options:       [
                          "Mortgage Assesment",
                        ...
                        labelStyle: theme.textTheme.titleMedium?.copyWith(fontSize: width* 0.041),
