...
class MortgageFormScreen extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            CustomeTextFeild(label:   "Name of Mortgage",
  ...
  Widget _dropdownField(String label, List<String> options, RxString selected,BuildContext context) {
    final height = MediaQuery.of(context).size.height;
    final width = MediaQuery.of(context).size.width;
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
   ...
   Widget _checkboxField(String label, RxBool checkBoxValue, BuildContext context) {
     final height = MediaQuery.of(context).size.height;
     final width = MediaQuery.of(context).size.width;
     return Row(
       ...
       children: [
         Obx(() => Checkbox(
           ...
           side: const BorderSide(color: Colors.white), // Border for inactive state
          ...
          child: Container(
            ...
            child:  Column(
              ...
              children: [
                ...
                Text('Upload Documents',style: theme.textTheme.bodyLarge?.copyWith(
