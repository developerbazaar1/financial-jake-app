class AppText {
  ...
  static const String fullTimeType = "Full Time";
  ...
  static const String onboarding1Content =
      "Easily find and connect with service providers near you.";
  static const String onboarding2Content =
      "Specify your budget to get services that fit your needs.";
  static const String onboarding3Content =
      "Create detailed job listings and attract the best Service Partners.";
  static const String onboardingExtra =
      "All the recruiting companies undergo KYC to avoid fraudulent cases.";
...
//Sign In
  ...
  //Forget Password
  static const String HeadingTextForgetPassword = "Forgot Password";
  ...
  static const String sentLink = "We sent a reset link to ";
  ...
  //Register
  static const String registerForFree = "Register for free";
  static const String signUpWithGoogle = "Register with Google";
  static const String alreadyhaveAccout = "Already a member? ";
