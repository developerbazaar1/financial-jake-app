...
//   const AppFirebaseException([this.message = "An Unknown error occurred."]);

//   factory AppFirebaseException.code(String code) {
//     switch (code) {
//       case 'permission-denied':
//         return const AppFirebaseException('Permission denied.');
//       case 'not-found':
//         return const AppFirebaseException('Not found.');
//       case 'unknown':
//         return const AppFirebaseException('An unknown error occurred.');
//       default:
//         return AppFirebaseException('Firebase Error: $code');
//     }
//   }
// }
