...
//   const AppFirebaseAuthException([this.message = "An Unknown error occurred."]);

//   factory AppFirebaseAuthException.code(String code) {
//     switch (code) {
//       case 'invalid-email':
//         return const AppFirebaseAuthException('Invalid email address.');
//       case 'user-disabled':
//         return const AppFirebaseAuthException('This user has been disabled.');
//       case 'user-not-found':
//         return const AppFirebaseAuthException('User not found.');
//       case 'wrong-password':
//         return const AppFirebaseAuthException('Incorrect password.');
//       case 'email-already-in-use':
//         return const AppFirebaseAuthException('Email is already in use.');
//       case 'weak-password':
//         return const AppFirebaseAuthException('Password is too weak.');
//       case 'operation-not-allowed':
//         return const AppFirebaseAuthException('Operation not allowed.');
//       default:
  ...
  String get message {
    switch (code) {
      ...
      case 'invalid-credential':
        return 'Invalid Email/Password. Please check your credentials and try again.';
